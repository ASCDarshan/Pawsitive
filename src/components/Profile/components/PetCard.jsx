...
const PetAvatar = styled(Avatar)(({ petType }) => {
  ...
  if (petType === "dog") {
    gradient = "linear-gradient(135deg, #8A6CE0 0%, #6247AA 100%)";
  } else if (petType === "cat") {
    gradient = "linear-gradient(135deg, #9D8BE0 0%, #8068C6 100%)";
  } else if (petType === "bird") {
    gradient = "linear-gradient(135deg, #B3A4EC 0%, #9D8BE0 100%)";
  }
      ...
      <CardContent sx={{ pt: 0, flexGrow: 1, px: 2 }}>
        ...
        {pet.description && (
          <Box sx={{ mt: 2 }}>
            ...
            <Typography
              variant="body2"
              sx={{ color: "#5D5A72", fontSize: "0.875rem" }}
            >
              {pet.description}
            </Typography>
          </Box>
        ...
        <StyledAccordion>
          <AccordionSummary
            expandIcon={<ExpandMoreIcon sx={{ color: "#8A6CE0" }} />}
          >
            <SectionTitle>
        ...
        <StyledAccordion>
          <AccordionSummary
            expandIcon={<ExpandMoreIcon sx={{ color: "#8A6CE0" }} />}
          >
            <VaccineBadge badgeContent={pet.vaccinations?.length || 0}>
              <SectionTitle>
                  ...
                  {pet.vaccinations.map((vaccination, index) => (
                    <Box
                      ...
                      sx={{
                        ...
                        borderBottom:
                          index < pet.vaccinations.length - 1
                            ? "1px solid #EAE4FF"
                            : "none",
                      }}
                    >
                      ...
                      >
                        <ValueText sx={{ color: "#6247AA" }}>
                          {vaccination.name}
                        </ValueText>
                        {vaccination.nextDue &&
                          getVaccinationStatusChip(vaccination)}
                      </Box>
      ...
      <StyledCardActions sx={{ justifyContent: "space-between" }}>
        <FormControlLabel
          ...
          label={
            ...
            >
              <FavoriteIcon
                sx={{ color: "#FF7BAC", fontSize: "1rem", mr: 0.5 }}
              />{" "}
              Mating
            </Typography>
          }
